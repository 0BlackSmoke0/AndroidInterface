package com.example.easyagro.Insumo;
...
public class MainActivityGraficoInsumo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_grafico_insumo);
